...
# User Modifications (Post v10):
# - Changed tab names and icons
# - Removed sidebar footer info
# - Added data sample to first tab, made it dynamic, and reordered
# - Implemented expanders for 2PT/3PT rankings
...
# --- Helper Functions ---
# (All helper functions remain the same as in version v10)
